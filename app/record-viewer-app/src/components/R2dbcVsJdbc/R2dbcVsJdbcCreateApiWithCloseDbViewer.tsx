...
import reactorSimpleApiBlockDbOutput from "../../records/r2dbc-vs-jdbc/close/reactor-create-api-block-db-output.json";
import reactorSimpleApiNonBlockDbOutput from "../../records/r2dbc-vs-jdbc/close/reactor-create-api-non-block-db-output.json";
 ...
 * @constructor
 */
export const R2dbcVsJdbcCreateApiWithCloseDbViewer = () => {
    return (
        <RecordViewerLayout
            title={"생성 API(가까운 거리의 DB)"}

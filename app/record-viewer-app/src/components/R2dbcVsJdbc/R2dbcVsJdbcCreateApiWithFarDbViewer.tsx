...
import reactorSimpleApiBlockDbOutput from "../../records/r2dbc-vs-jdbc/far/reactor-create-api-block-db-output.json";
import reactorSimpleApiNonBlockDbOutput from "../../records/r2dbc-vs-jdbc/far/reactor-create-api-non-block-db-output.json";
 ...
 * @constructor
 */
export const R2dbcVsJdbcCreateApiWithFarDbViewer = () => {
    return (
        <RecordViewerLayout
            title={"생성 API(먼 거리의 DB)"}
